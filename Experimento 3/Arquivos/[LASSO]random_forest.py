...
def perform_lasso_with_grid_search(X, y, param_grid, output_file, run_id,random_state):
    ...
    print("Realizando seleção de features com LASSO...")
    alphas = [0.001, 0.05, 0.1]#0.001 melhor
    lasso = LassoCV(alphas=alphas, cv=5, random_state=random_state).fit(X_train_bal, y_train_bal)
...
if __name__ == "__main__":
    ...
    output_file = "AG_DOUTORADO_RESULTS_LASSO_EXP3.csv"
    ...
    for run_id in range(1, 11):
        ...
        perform_lasso_with_grid_search(
